...
<head>
    ...
    <title class="text-capitalize">{{\Request::route()->getName()=='website' ? env('APP_NAME') : \Request::route()->getName() .'|'. env('APP_NAME')}}</title>
    <!-- Preloader -->
    <style>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('frontend/assets/img/brand/favicon.png')}}" type="image/png"><!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('frontend/assets/libs/@fortawesome/fontawesome-free/css/all.min.css')}}">
    <!-- Quick CSS -->
    <link rel="stylesheet" href="{{asset('frontend/assets/css/quick-website.css')}}" id="stylesheet">
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <a class="navbar-brand" href="{{route('website')}}">
            <img alt="Image placeholder" src="{{asset('frontend/assets/img/brand/dark.svg')}}" id="navbar-logo">
        </a>
        <!-- Toggler -->
        ...
        <div class="container pt-4">
            <div class="row">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <!-- Theme's logo -->
                    <a href="index.html">
                        <img alt="Image placeholder" src="{{asset('frontend/assets/img/brand/light.svg')}}" id="footer-logo">
                    </a>
                    <!-- Webpixels' mission -->
...
<script src="{{asset('frontend/assets/libs/svg-injector/dist/svg-injector.min.js')}}"></script>
<script src="{{asset('frontend/assets/libs/feather-icons/dist/feather.min.js')}}"></script>
<!-- Quick JS -->
<script src="{{asset('frontend/assets/js/quick-website.js')}}"></script>
<!-- Feather Icons -->
<script>
    feather.replace({
        'width': '1em',
